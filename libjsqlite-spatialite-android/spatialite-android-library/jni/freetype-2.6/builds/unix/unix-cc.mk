...
#
CPPFLAGS := 
CFLAGS   := -c -Wall -g -O2 -I/usr/local/include  -DFT_CONFIG_OPTION_SYSTEM_ZLIB  -DFT_CONFIG_OPTION_USE_BZIP2 -I/usr/local/include/libpng16  -DFT_CONFIG_OPTION_USE_PNG -I/usr/include/harfbuzz  -DFT_CONFIG_OPTION_USE_HARFBUZZ -DFT_CONFIG_CONFIG_H="<ftconfig.h>"
...
# Linker flags.
#
LDFLAGS :=  -L/usr/local/lib -lz  -lbz2 -L/usr/local/lib -lpng16  -lharfbuzz 
