...
TCCX = $(TCC) $(OPTS) -DWIN32=1 -DTHREADSAFE=1 -DSQLITE_SOUNDEX=1 \
	-I. -I$(TOP)/src
...
LIBOBJ = attach.obj auth.obj btree.obj btree_rb.obj build.obj copy.obj \
	 ...
	 table.obj tokenize.obj trigger.obj update.obj util.obj vdbe.obj \
	 where.obj encode.obj opcodes.obj vacuum.obj \
	 vdbeaux.obj
