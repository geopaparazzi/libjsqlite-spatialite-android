# VC++ 6.0 Makefile for SQLite 3.6.3
...
TCC = cl -Gs -GX -D_WIN32 -nologo -Zi -DSQLITE_OS_WIN=1
...
LIBOBJ = alter.obj analyze.obj attach.obj auth.obj bitvec.obj \
	 btmutex.obj btree.obj \
	 build.obj callback.obj complete.obj \
	 date.obj delete.obj expr.obj fault.obj func.obj global.obj hash.obj \
	 insert.obj journal.obj loadext.obj main.obj malloc.obj \
	 mem1.obj mem2.obj mem3.obj mem4.obj mem5.obj mem6.obj \
	 mutex.obj mutex_w32.obj opcodes.obj os.obj os_win.obj \
	 pager.obj parse.obj pcache.obj pragma.obj prepare.obj printf.obj \
	 random.obj resolve.obj select.obj status.obj table.obj tokenize.obj \
	 trigger.obj update.obj util.obj vacuum.obj vdbe.obj vdbeapi.obj \
	 vdbeaux.obj vdbeblob.obj vdbefifo.obj vdbemem.obj vtab.obj \
	 walker.obj where.obj utf.obj legacy.obj
...
bitvec.obj:	$(TOP)/src/bitvec.c $(HDR)
	$(TCCXD) -c $(TOP)/src/bitvec.c
...
mem5.obj:	$(TOP)/src/mem5.c $(HDR)
	$(TCCXD) -c $(TOP)/src/mem5.c

mem6.obj:	$(TOP)/src/mem6.c $(HDR)
	$(TCCXD) -c $(TOP)/src/mem6.c
...
pcache.obj:	$(TOP)/src/pcache.c $(HDR)
	$(TCCXD) -c $(TOP)/src/pcache.c
...
vdbefifo.obj:	$(TOP)/src/vdbefifo.c $(HDR)
