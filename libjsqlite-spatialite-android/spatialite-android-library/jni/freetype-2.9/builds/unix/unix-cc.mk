...
#
CPPFLAGS := 
CFLAGS   := -c -Wall -g -O2 -I/usr/local/include   -I/usr/local/include/libpng16 -I/usr/local/include  -I/usr/include/harfbuzz  -DFT_CONFIG_CONFIG_H="<ftconfig.h>"
...
# Linker flags.
#
LDFLAGS           :=  -L/usr/local/lib -lz  -lbz2 -L/usr/local/lib -lpng16 -lz  -lharfbuzz 
