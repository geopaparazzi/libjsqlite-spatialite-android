...
#define RL2_DEFAULTS_START			0x57
#define RL2_DEFAULTS_END			0x5a
...
#define RL2_ORIGIN_TIFF			0x4f
 ...
 char *COPYRIGHT;
    ...
    typedef struct rl2_priv_raster_defaults
    {
     double center_x;
     double center_y;
     unsigned char zoom_min;
     unsigned char zoom_default;
     unsigned char zoom_max;
    } rl2PrivRasterDefaults;
    typedef rl2PrivRasterDefaults *rl2PrivRasterDefaultsPtr;
 ...
 rl2PrivRasterDefaultsPtr raster_defaults;
 ...
 sqlite3 *handle;
    ...
    RL2_PRIVATE int set_coverage_infos (sqlite3 * handle,
     ...
     RL2_PRIVATE int set_coverage_nodata (sqlite3 * handle,
					const char *coverage_name,
     rl2PixelPtr no_data);
