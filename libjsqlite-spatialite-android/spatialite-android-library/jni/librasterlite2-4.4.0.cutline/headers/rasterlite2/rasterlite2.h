 ...
 */
 ...
 \param cvg pointer to the Coverage Object.
 \param title on completion the variable referenced by this
 pointer will contain the title.
 \param pixel_type on completion the variable referenced by this
 pointer will contain the abstract.
  \param pixel_type on completion the variable referenced by this
 pointer will contain the copyright.
 
 \return  RL2_OK on success: RL2_ERROR on failure.

 \sa rl2_create_coverage
 */
    RL2_DECLARE int rl2_get_coverage_infos (rl2CoveragePtr cvg,
					   char *title,
					   char *abstract,
        char *copyright);
 ...
 */
    ...
    RL2_DECLARE int
	   rl2_resolve_image_sanity (sqlite3 * handle,
					       const char *coverage,
